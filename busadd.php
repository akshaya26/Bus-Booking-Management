...
<br></br><br></br><br></br>  
<table align="center">
	<form action="busadlink.php" method="post" >
<!--<tr><th><h1 align=>BUS</h1></th></tr>-->
	<tr><td>
	<input  type="text" name="busid"   placeholder="Bus ID" required autofocus></tr></td>
	<tr><td>
	<input  type="text" name="bname"   placeholder="Bus Name" required></tr></td>
	<tr>
	...
	<tr><td>
	<input  type="text" name="src"   placeholder="Source" required></tr></td>
	<tr><td>
