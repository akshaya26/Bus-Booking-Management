...
$sql =  "SELECT booking.busid,bname,username,booking.src,booking.dest,doj,rate from booking,bus where username='$user' and sts='CANCEL' and bus.busid=booking.busid";
...
echo"<table  cellpadding='20' width='800' height='50' align='center'  >
			...
			<td width='500' align='center'><b>USERNAME</b></td>
...
if ($result->num_rows > 0) {
  ...
  <tr>
	...
	<td width='500' align='center'>". $row["username"]."</td>
