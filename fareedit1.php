...
<br></br><br></br><br></br>  
<table align="center">
	<form action="fareeditlink.php" method="post">
	...
	<tr><td>
	<input  type="number" name="rate1"   placeholder="Old Fare" required></tr></td>
	<tr><td>
	<input  type="number" name="rate2"   placeholder="New Fare" required></tr></td>
