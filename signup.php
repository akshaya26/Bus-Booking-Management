...
<body style="background-image:url('bus5');"
<body>
  <div class="wrapper">
  
  <form class="login" action="signuplink.php" method="post" >
	...
	<input type="number" placeholder="Mobile" name="mobile" required /><i class="fa fa-mobile"></i>
